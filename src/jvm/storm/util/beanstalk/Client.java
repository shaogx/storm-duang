...
public class Client {
	 ...
	 */
	private byte[] readData(int bytes) throws IOException, ClientException {
	 ...
	 * @throws ClientException 
	 */
	private Job readJob() throws IOException, ClientException {
		...
		if ((resp.length == 3) && (resp[0].equals("RESERVED") || resp[0].equals("FOUND"))) {
			...
			throw new ClientException(String.format("%s", resp[0]));
		}
		
		
	}
	
	private byte[] readYaml() throws IOException, ClientException {
		...
		if (resp.length == 2 && resp[0].equals("OK")) {
			...
			throw new ClientException(resp[0]);
		}
	 ...
	 * @throws IOException
	 */	
	public long put(byte[] data, long priority, int delay, int ttr) throws IOException, ClientException {
		...
		if (resp[0].equals("INSERTED") && (resp.length == 2)) {
			...
			throw new ClientException(String.format("%s %d", resp[0], Long.valueOf(resp[1])));
		} else {
			throw new ClientException(resp[0]);
		}
	 ...
	 */
	public long put(byte[] data) throws IOException, ClientException {		
	 ...
	 * @see #put(byte[], long, int, int)
	 */
	public long put(byte[] data, long priority) throws IOException, ClientException {		
	 ...
	 * @see #put(byte[], long, int, int)
	 */
	public long put(byte[] data, long priority, int delay) throws IOException, ClientException {		
	 ...
	 * @throws ClientException
	 */
	public void use(String tube) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public Job reserve(int timeout) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public Job peek(long jobId) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public Job peekReady() throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public Job peekDelayed() throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public Job peekBuried() throws IOException, ClientException {
	 ...
	 * @see #reserve(int) 
	 */
	public Job reserve() throws IOException, ClientException {
		return reserve(0);
	}
	 ...
	 * @throws ClientException
	 */
	public void delete(long jobId) throws IOException, ClientException {
		...
		if (!resp[0].equals("DELETED")) {
			throw new ClientException(String.format("%s, JOBID=[%d]", resp[0], jobId));
		}
	 ...
	 * @see #delete(long) 
	 */
	public void delete(Job job) throws IOException, ClientException {
		delete(job.getId());
	}
	 ...
	 * @throws ClientException 
	 */
	public void release(long jobId, long priority, int delay) throws IOException, ClientException {
		...
		if (!resp[0].equals("RELEASED")) {
			throw new ClientException(String.format("%s, [JOBID=%d, PRIORITY=%d, DELAY=%d]", resp[0], jobId, priority, delay));
		}
	 ...
	 */	
	public void release(long jobId, long priority) throws IOException, ClientException {
	 ...
	 * @see #release(long, long, int)
	 */	
	public void release(long jobId) throws IOException, ClientException {
	 ...
	 * @see #release(long, long, int)
	 */	
	public void release(Job job, long priority, int delay) throws IOException, ClientException {
	 ...
	 * @see #release(long, long, int)
	 */	
	public void release(Job job, long priority) throws IOException, ClientException {
	 ...
	 * @see #release(long, long, int)
	 */	
	public void release(Job job) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public void bury(long jobId, long priority) throws IOException, ClientException {
		...
		if (!resp[0].equals("BURIED")) {
			throw new ClientException(String.format("%s, JOBID=[%d, PRIORITY=%d]", resp[0], jobId, priority));
		}
	 ...
	 * @see #bury(long, long)
	 */
	public void bury(long jobId) throws IOException, ClientException {		
	 ...
	 * @throws ClientException
	 */
	public int watch(String tube) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public int ignore(String tube) throws IOException, ClientException {
		...
		if (resp[0].equals("WATCHING")) {
			...
			throw new ClientException(String.format("%s [TUBE=%s]", resp[0], tube));
		}
	 ...
	 * @throws ClientException
	 */
	public int kick(int bound) throws IOException, ClientException {
		...
		if (resp[0].equals("KICKED")) {
			...
			throw new ClientException(String.format("%s [BOUND=%d]", resp[0], bound));
		}
	 ...
	 * @throws ClientException
	 */
	public void touch(long jobId) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public void pauseTube(String tube, int delay) throws IOException, ClientException  {
		...
		if (!resp[0].equals("PAUSED")) {
			throw new ClientException(String.format("%s [TUBE=%s,DELAY=%d]", resp[0], tube, delay));
		}
	 ...
	 * @throws ClientException
	 */
	public HashMap<String,String> stats() throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public HashMap<String,String> statsJob(long jobId) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public HashMap<String,String> statsTube(String tube) throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public List<String> listTubes() throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public String listTubeUsed() throws IOException, ClientException {
	 ...
	 * @throws ClientException
	 */
	public List<String> listTubesWatched() throws IOException, ClientException {
